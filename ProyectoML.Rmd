...
```{r}
datos_relativizados <- as.data.frame(scale(data[, c("Enfermedad_Cardiaca_Ataque", "Presion_Sanginea_Alta",
                                            "Colesterol_Alto", "Control_Colesterol", "IMC", "Fumador", "Actividad_Fisica",
                                            "Frutas", "Verduras", "Consumo_Alcohol",
                                            "Cuidado_Salud", "No_Doctor_Caro",
