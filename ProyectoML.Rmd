...
Segun esta grafica, podemos observar que necesitaremos entre 33 y 43 covariables ya que la primera linea sabemos que indica el ECM minimo en escala logaritmica con log(lamnda) = -7 aproximadamente y la siguiente linea de puntos verticales indica el valor de landa que estaria a menos de 1 error estandard. Por tanto, nos interesa elegir el numero de covariables que se relaciona en esa linea de puntos que aproximadamente será entre 33 y 34 covariables (contando como covariables tambien las categorias de aquellas variables categoricas). 
