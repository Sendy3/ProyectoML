...
cat('Sensitivity: ',sen,'   Specifity: ',spe)
tot<-(tt[1,1] + tt[2,2]) / sum(tt)
cat('Well-classified (Bayes): ',round(100*tot,2),'%')
...
<!-- ```{r} -->
<!-- variables_numericas <- c("IMC", "Salud_Mental","Salud_Fisica", "Ingreso") -->

<!-- datos_relativizados <- as.data.frame(scale(datos[, variables_numericas]))   -->
...
```{r}
#Ajuste normal
print("Especificidad: ", spe_normal)
print("Sensibilidad: ", sen_normal)
print("Porcentaje: ", porcentaje_normal, "%")

#Ajuste bueno
print("Especificidad: ", spe_bueno)
print("Sensibilidad: ", sen_bueno)
print("Porcentaje: ", porcentaje_bueno, "%")

#Ajuste lasso
print("Especificidad: ", spe_lasso)
print("Sensibilidad: ", sen_lasso)
print("Porcentaje: ", porcentaje_lasso, "%")
